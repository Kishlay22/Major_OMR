...
def openfile():
    ...
    try:
        ...
        messagebox.showerror("Error","No OMR was detected or scanning algorithm didn't work. Try again...")
        print(e)
...
def handleScanning(img):
    ...
    try:
        ...
        messagebox.showerror("Error","Only enter integer value in InkThreshold")
        inkThreshold = 120
    ...
    #Loading Answers
    try:
        with open(answerKeyFilepath,'r') as f:
            for line in f:
        ...
        if len(answers) != totalQuestions:
            ...
            messagebox.showwarning("Warning","Answer key that is attached doesn't have answer to every question.")
    ...
    try:
        ...
        messagebox.showerror("Error","Please Enter only numbers in Point for correct & wrong input fields.")
...
def deletetemp():
    ...
    if os.path.exists(".temp"):
        try:
            ...
            # Permission denied to delete the directory
            print("Permission denied to delete directory temp")
        except Exception as e:
            # Other unexpected errors
            print("An error occurred while deleting directory temp:", e)
    root.destroy()
...
def presetProcessor(presetString,scanningMethod):
    ...
    try:
        ...
        messagebox.showerror("Corrupted Preset","The preset you are trying to use is corrupted. Re-make the preset or use another one.")
        print(e)
